...
def students_lookup_func():
    students_lookup_url = "https://tcas67.as.r.appspot.com/applicants/student-lookup"
...
def login_func():
    login_url = "https://tcas67.as.r.appspot.com/applicants/login-with-password"
...
def Tgat_Tpat_func():
    Tgat_Tpat_url = "https://tcas67.as.r.appspot.com/applicants/me/exam-applications"
    headers = {
...
def A_level_func():
    A_level_url = "https://tcas67.as.r.appspot.com/applicants/me/exam-applications?type=alevel"
    headers = {
        "Accesstoken":access_token
    }
    try:
